...
def create_rag_chain(vector_store, llm_model_name="qwen3:4b", context_window=8192):
...
if __name__ == "__main__":
    ...
    # 5. Create RAG Chain
    rag_chain = create_rag_chain(vector_store, llm_model_name="qwen3:4b") # Use the chosen Qwen 3 model
